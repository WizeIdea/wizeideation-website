...
export default function AboutPage() {
  return (
    <section className="max-w-4xl mx-auto font-serif-body text-base">
      ...
      <p className="mb-4 leading-relaxed text-striationCharcoal">Wize Idea is a technical consultancy and independent research practice operating at the intersection of artificial intelligence, systems architecture, and human authorship.</p>
